...
res\Toolbar.bmp
    ...
    初始工具列和狀態列會在 CMainFrame 類別中建構。請使用資源編輯器編輯這個工具列點陣圖，並更新 MFCApplication3.rc 中的 IDR_MAINFRAME TOOLBAR 陣列，以加入工具列按鈕。
/////////////////////////////////////////////////////////////////////////////

應用程式精靈會建立一個文件類型及一個檢視表：

MFCApplication3Doc.h、MFCApplication3Doc.cpp - 文件
    這些檔案包含您的 CMFCApplication3Doc 類別。編輯這些檔案，可加入您的特殊文件類型並實作檔案儲存和載入 (透過 CMFCApplication3Doc::Serialize)。

MFCApplication3View.h、MFCApplication3View.cpp - 文件的檢視表
    這些檔案包含您的 CMFCApplication3View 類別。
    CMFCApplication3View 物件是用來檢視 CMFCApplication3Doc 物件。
