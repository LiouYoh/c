...
// 初始置換錶  
int  IP[] = {2, 50, 42, 34, 26, 18, 10, 58,  
            62, 52, 44, 36, 28, 20, 12, 4,  
            60, 54, 46, 38, 30, 22, 14, 6,  
...
// 結尾置換錶  
int  IP_1[] = {40, 1, 48, 16, 56, 24, 64, 32,  
...
/** 
 * 密碼函數f，接收32位數據和48位子密鑰，產生一個32位的輸出             
 */  
...
/************************************************* *********************/  
/* 測試： */  
/* 1.將一個 64 位的字符串加密， 把密文寫入文件 a.txt */  
...
int  main() {  
    ...
    while(getline(ss,sub_str,' ')){
        bitset<64> plain = charToBitset(sub_str.c_str());  
    ...
    // 密文寫入 a.txt  
    	...
    	fstream file1;  
    	file1.open( "D://a.txt" , ios::binary | ios::app);  
    ...
    file1.open( "D://a2.txt" , ios::binary | ios::out);  
